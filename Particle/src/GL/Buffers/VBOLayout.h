...
namespace GL   
{
    ...
    template<>
    inline void VBOLayout::push<float>(unsigned int count)
    {
    ...
    template<>
    inline void VBOLayout::push<unsigned int>(unsigned int count)
    {
    ...
    template<>
    inline void VBOLayout::push<unsigned char>(unsigned int count)
    {
